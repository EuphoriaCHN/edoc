<ChartsIndentedTree {...({
    data: { id: 'A', label: 'A', description: 'node Anode Anode Anode a', children: [
        { id: 'A1', label: 'A1', description: 'node A1', children: [
        ...
        { id: 'A2', label: 'A2', description: 'node A2\nnode A2\nnode A2\nnode A2\nnode A2', children: [
            { id: 'A21', label: 'A21', description: 'node A21', children: [
                { id: 'A211', label: 'A211', description: 'node A211' },
                { id: 'A212', label: 'A212', description: 'node A212' },
              ],
            },
            { id: 'A22', label: 'A22', description: 'node A22' },
          ],
        },
      ],
    },
